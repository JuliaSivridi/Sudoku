...
// Полупрозрачный оранжевый — одинаково работает в обеих темах
val CellDigitHighlight = Color(0x33CF7A30)   // ~20% alpha Orange, смотрится как в ряду цифр
...
val ConflictColorLight = Color(0xFFCC2929)   // яркий красный, светлая тема
val ConflictColorDark = Color(0xFFFF7070)    // яркий розово-красный, тёмная тема
